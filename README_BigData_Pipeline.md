...
> Mini pipeline Big Data end-to-end — ingestion streaming via Kafka, traitement temps réel avec Spark Structured Streaming, détection d'anomalies par scoring et stockage dans un Data Lake local.
